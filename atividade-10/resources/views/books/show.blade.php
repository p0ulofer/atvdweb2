...
<div class="container">
    ...
    {{-- ALERTA DE LIVRO EMPRESTADO --}}
    @if($book->isBorrowed())
        <div class="alert alert-warning">
            Este livro está atualmente <strong>emprestado</strong> e não pode ser emprestado novamente.
        </div>
    @endif
        ...
        <div class="card-body">
            ...
            <form action="{{ route('books.borrow', $book) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="user_id" name="user_id" {{ $book->isBorrowed() ? 'disabled' : '' }}>
                ...
                {{-- BOTÃO BLOQUEADO SE O LIVRO ESTIVER EMPRESTADO --}}
                @if($book->isBorrowed())
